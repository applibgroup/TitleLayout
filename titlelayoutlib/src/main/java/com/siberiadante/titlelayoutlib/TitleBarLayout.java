...
public class TitleBarLayout extends RelativeLayout {
    ...
    public TitleBarLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mLeftImagePaddingEnd = attributes.getDimensionPixelSize(R.styleable.TitleBarLayout_d_left_image_padding_end, mLeftImagePaddingEnd);
        ...
        mLeftTextPaddingEnd = attributes.getDimensionPixelSize(R.styleable.TitleBarLayout_d_left_text_padding_end, mLeftTextPaddingEnd);
        ...
        mRightImagePaddingStart = attributes.getDimensionPixelSize(R.styleable.TitleBarLayout_d_right_image_padding_start, mRightImagePaddingStart);
        /*
        ...
        mRightTextPaddingStart = attributes.getDimensionPixelSize(R.styleable.TitleBarLayout_d_right_text_padding_start, mRightTextPaddingStart);
